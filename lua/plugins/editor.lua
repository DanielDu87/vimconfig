	...
	-- ---------------------------------------------------------------------------
	{
		...
		opts = {
			...
			replace = {
				desc = {
					-- 搜索与 Grep 相关
					{ "Grep (Root Dir)", "项目全局搜索" },
					{ "Grep (cwd)", "当前目录搜索" },
					{ "Grep", "正则搜索" },
					{ "Word (Root Dir)", "搜索当前单词 (全局)" },
					{ "Word (cwd)", "搜索当前单词 (目录)" },
					{ "Word", "搜索选中/单词" },
					{ "Find Files (Root Dir)", "搜索文件名 (项目)" },
					{ "Find Files (cwd)", "搜索文件名 (目录)" },
					{ "Find Files", "查找文件" },
					{ "Search History", "查找搜索历史" },
					{ "Recent Files", "最近打开文件" },
					...
					{ "Git Stash", "查看 Git 暂存" },
					{ "Git Blame Line", "显示当前行 Git 信息" },
					{ "Git Log", "查看提交历史" },
					{ "Lazygit", "LazyGit 面板" },
					{ "Commits", "查看提交 (Commits)" },
					{ "Status", "查看状态" },
					{ "Branches", "切换分支" },
					{ "Diff (Split)", "分屏差异对比" },
					...
					{ "Rename", "变量/函数重命名" },
					{ "Hover", "显示文档悬浮窗" },
					{ "LSP Symbols", "列出 LSP 符号" },
					{ "LSP Workspace Symbols", "全局 LSP 符号" },
					...
					{ "Toggle Diagnostics", "切换诊断提示" },
					{ "Toggle Conceal", "切换隐藏字符" },
					{ "Toggle Spell", "切换拼写检查" },
					{ "Toggle Background", "切换深/浅色模式" },
					{ "Toggle Pin", "切换固定状态" },
					{ "Toggle Zen Mode", "切换禅模式" },
					{ "Toggle Treesitter Context", "切换代码结构提示" },
